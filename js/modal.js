...
function openImageModal() {
    ...
    if (modalController) {
        modalController.openModal('image', {
            imageUrl: 'img/KLTN_SOC-Ecosystem-LogicFlow.drawio.png',
...
function openPipelineModal() {
    ...
    if (modalController) {
        modalController.openModal('image', {
            imageUrl: 'img/KLTN_SOC-Ecosystem-Pipeline.drawio.png',
            alt: 'SOC Ecosystem Pipeline'
        });
    }
}

function openSmartXDRModal() {
    const modalController = window.modalController;
    if (modalController) {
        modalController.openModal('image', {
            imageUrl: 'img/KLTN_SOC-Ecosystem-SmartXDR.drawio.png',
            alt: 'SmartXDR Architecture'
        });
    }
}
...
window.openSmartXDRModal = openSmartXDRModal;
